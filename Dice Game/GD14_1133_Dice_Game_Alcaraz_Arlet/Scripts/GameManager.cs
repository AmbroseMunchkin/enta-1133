...
namespace GD14_1133_Dice_Game_Alcaraz_Arlet.Scripts
{
    internal class GameManager
    {
        ...
        private static void Outro()
        {
            ...
            Console.WriteLine("(-): Subtracts one value from another, for example 7 - 4 = 3"); //From line 28 to line 31 its common operations that i didn't need to find the explanation
            ...
            Console.WriteLine("(--): Decreases the value of a variable by 1, for example w = 16, so w-- = 15)"); //Pretty much the same reasoning of the ++ we saw in class, just subtracting instead of adding
